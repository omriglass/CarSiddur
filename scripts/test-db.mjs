...
for (const file of ["rls_smoke.sql", "solve_semantics.sql", "todo_board_semantics.sql", "one_way_lifecycle.sql", "proposal_replacement.sql", "live_quick_one_way.sql", "selected_day_publication.sql", "coordinator_planning.sql", "proposal_day_boundary.sql"]) {
