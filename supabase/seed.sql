...
-- ---------------------------------------------------------------------------
insert into public.destinations (id, name, zone, distance_km, travel_minutes, public_transport_score, is_approved)
values
  ('00000000-0000-0000-0000-000000000010', 'נבו', 'home', 0, 0, null, true),
  ('00000000-0000-0000-0000-000000000011', 'חיפה', 'haifa', 12.0, 20, 4, true),
  ('00000000-0000-0000-0000-000000000012', 'בנימינה', 'north', 6.5, 10, 3, true),
  ('00000000-0000-0000-0000-000000000013', 'זכרון יעקב', 'north', 8.0, 12, 2, true),
  ('00000000-0000-0000-0000-000000000014', 'קיסריה', 'north', 15.0, 18, 1, true),
  ('00000000-0000-0000-0000-000000000015', 'תל אביב', 'tel_aviv', 55.0, 55, 5, true),
  ('00000000-0000-0000-0000-000000000016', 'עפולה', 'north', 30.0, 35, 2, true),
  ('00000000-0000-0000-0000-000000000017', 'פרדס חנה', 'north', 4.0, 8, 2, true),
  ('00000000-0000-0000-0000-000000000018', 'נתניה', 'sharon', 40.0, 40, 3, true),
  ('00000000-0000-0000-0000-000000000019', 'ירושלים', 'jerusalem', 110.0, 100, 3, true)
...
-- Ride types
-- ---------------------------------------------------------------------------
insert into public.ride_types (id, code, name_he, sort_order)
values
  ('00000000-0000-0000-0000-000000000021', 'work', 'עבודה', 1),
  ('00000000-0000-0000-0000-000000000022', 'childcare', 'ילדים', 2),
  ('00000000-0000-0000-0000-000000000023', 'healthcare', 'בריאות', 3),
  ('00000000-0000-0000-0000-000000000024', 'errands', 'סידורים', 4),
  ('00000000-0000-0000-0000-000000000025', 'other', 'אחר', 5)
on conflict (id) do nothing;

-- ---------------------------------------------------------------------------
-- Default priority policy (global), 8 rule types, fairness lookbackWeeks = 3
-- (SOLVER.md §4.4 example policy).
-- ---------------------------------------------------------------------------
insert into public.policies (id, department_id, name, is_active)
values ('00000000-0000-0000-0000-000000000030', null, 'ברירת מחדל', true)
on conflict (id) do nothing;
