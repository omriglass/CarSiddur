...
## Flaky / time-dependent e2e specs (found 2026-09-11 clean-slate run: 61 passed, 2 flaky, 3 failed) — the two open items need a Playwright run, which resets the local database; awaiting the owner's go (asked 2026-09-14)
...
- **E2E audit** (owner: run the suite only after checking each spec still makes sense) — `docs/E2E_AUDIT_2026-09-14.md`, then a full run on the local stack (owner-approved reset).
