 ...
 * REQUIREMENTS §13.81; UX_FLOWS.md relevant screen sections).
 *
...
export type NewRequestButtonState =
  ...
  | { kind: "waitlistThisWeek"; weekStart: string };
...
export function newRequestButtonState(weeks: readonly NewRequestButtonWeek[]): NewRequestButtonState {
  ...
  if (live) return { kind: "waitlistThisWeek", weekStart: live.week_start };
