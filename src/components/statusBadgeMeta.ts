 ...
 * on features).
 */
export type InviteRowStatus = "new" | "existing" | "invalid_email" | "duplicate";
...
export const CAR_STATUS_META: Record<CarStatus, StatusMeta> = {
 ...
 */
export const WEEK_PHASE_META: Record<WeekPhase, StatusMeta> = {
...
export const CAR_ISSUE_STATUS_META: Record<CarIssueStatus, StatusMeta> = {
...
export const INVITE_ROW_STATUS_META: Record<InviteRowStatus, StatusMeta> = {
 ...
 */
export function metaFor(props: StatusBadgeProps): StatusMeta {
  switch (props.kind) {
    case "request":
