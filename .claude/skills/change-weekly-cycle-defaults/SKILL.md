...
- `department_settings`: `open_dow/open_time` (default Sun 00:00), `close_dow/close_time` (Wed 12:00), `closing_reminder_hours int[]` ('{24,2}'), `publish_dow/publish_time` (Wed 20:00), `turnaround_buffer interval` ('15 minutes'), `detour_limit_minutes` (20), `detour_limit_km` (15), `proposal_expiry_mode` ('at_publish' | 'fixed_hours'), `proposal_expiry_hours` (24), `auto_apply_accepted_proposals` (true), `board_start_time` ('05:00'), `fairness_lookback_weeks` (8), `weeks_open_ahead` (1), `members_may_add_temp_cars` (true), `overrides jsonb`. The late penalty is a policy param (`submissionTime.latePenalty`, SOLVER §4.3), not a setting.
